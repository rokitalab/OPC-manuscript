...
![**Medulloblastoma Sample Clustering.** __A-B__. UMAP projection of __A)__ 271 medulloblastoma (MB) samples and __B)__ 63 MB, SHH-activated samples by beta values of 20,000 most variable probes on the Infinium MethylationEPIC array.  __C__. UMAP projection of MB, SHH activated samples indicating copy number status of known somatic driver genes.](https://raw.githubusercontent.com/d3b-center/OpenPedCan-analysis/c4dc61e9388033abae631bb3a8ea645f7408b8a1/figures/manuscript_OPC/figure3/Figure3.png?sanitize=true){#fig:Fig3 width="7in"}
...
Furthermore, we classified MB, SHH subtype tumors into four subgroups (alpha, beta, gamma, delta) using methylation classification as well as demographic and molecular criteria as follows:
