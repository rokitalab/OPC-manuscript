...
Instead of the b-allele frequency germline input file, we used the `dbSNP_v153_ucsc-compatible.converted.vt.decomp.norm.common_snps.vcf.gz` [dbSNP common snps file](https://s3.amazonaws.com/kids-first-seq-data/pipeline-references/dbSNP_v153_ucsc-compatible.converted.vt.decomp.norm.common_snps.vcf.gz) and to avoid hard-to-call regions, utilized the `hg38_canonical_150.mappability` [mappability file](https://s3.amazonaws.com/kids-first-seq-data/pipeline_references/hg38_canonical_150.mappability).
