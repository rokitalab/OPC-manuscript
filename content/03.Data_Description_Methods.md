...
Furthermore, we classified MB, SHH subtype tumors into four subgroups (alpha, beta, gamma, delta) using methylation classification, demographic and molecular criteria as follows:
...
3. _MB, SHH gamma_: sample has a high-confidence "MB_SHH_2" methylation classification, or patient had an age at diagnosis < 5 years and tumor harbored a chromsome 2p arm gain. 
