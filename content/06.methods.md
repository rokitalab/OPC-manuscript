...
We preprocessed raw Illumina Infinium Human Methylation Bead Arrays (450K and EPIC(850K)) intensities using the array preprocessing methods implemented in the minfi Bioconductor package[@doi:10.1093/bioinformatics/btw691]. 
...
Detailed implementation of the classifier is described in `Caper et al., 2018` [@doi:10.1038/nature26000]. 
